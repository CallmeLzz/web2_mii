<div class="main">
    ...
    <table style="width: 100%">
        ...
        <tr>
            {{ Form::open(['method' => 'POST', 'action' => 'Admin\addController@addData_content_sml', 'files' => 'true']) }}
                <td>{{ Form::text('content_sml_title', null, array('autofocus', 'class' => 'width_box')) }}</td>
                <td>{{ Form::file('content_sml_img', array('class' => 'width_box')) }}</td>
                <td>{{ Form::text('content_sml_description', null, array('class' => 'width_box')) }}</td>
