            ...
            <div class="col-md-9 col-sm-12 col-xs-12">
                ...
                <?php $i = 1; ?>
                    ...
                    <?php else: ?>
                        ...
                        <li><a href="<?php echo e(URL::route('list')); ?>?page=<?php echo e($index); ?>">&laquo;</a></li>
                    <?php endif; ?>
                        <?php while($i <= $products->lastPage()): ?>
                        <?php  ?>
                            <?php if($products->currentPage() == $i): ?>
                                <li class="disabled"><a href="<?php echo e(URL::route('list')); ?>?page=<?php echo e($i); ?>"><?php echo e($i); ?></a></li>
                            <?php else: ?>
                                <li><a href="<?php echo e(URL::route('list')); ?>?page=<?php echo e($i); ?>"><?php echo e($i); ?></a></li>
                            <?php endif; ?>
                            <?php $i++; ?>
                        <?php endwhile; ?>
                    ...
                    <?php else: ?>
                        <?php $index = $products->currentPage(); $index++; ?>
                        <li><a href="<?php echo e(URL::route('list')); ?>?page=<?php echo e($index); ?>">&raquo;</a></li>
                    <?php endif; ?>
                </ul>
                <!------------------------------------------------------------------------>
            </div>
